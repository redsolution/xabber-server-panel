...
INSTALLED_APPS = [
    ...
    'xmppserverui.apps.XMPPServerUIConfig',
    'virtualhost.apps.VirtualhostConfig',
    'server',
...
EJABBERD_AUTH_CONFIG_FILE = 'auth_method.yml'
EJABBERD_LDAP_CONN_CONFIG_FILE = 'ldap_conn.yml'
EJABBERD_LDAP_AUTH_CONFIG_FILE = 'ldap_auth.yml'
