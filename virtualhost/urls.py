...
urlpatterns = [
    ...
    url(r'^users/(?P<user_id>[0-9]+)/block/$', custom_permission_required(('virtualhost.view_user', 'virtualhost.change_user'))(views.BlockUserView.as_view()), name='user-block'),
    url(r'^users/(?P<user_id>[0-9]+)/unblock/$', custom_permission_required(('virtualhost.view_user', 'virtualhost.change_user'))(views.UnblockUserView.as_view()), name='user-unblock'),
    url(r'^users/(?P<user_id>[0-9]+)/ban/$', custom_permission_required(('virtualhost.view_user', 'virtualhost.delete_user'))(views.BanUserView.as_view()), name='user-ban'),
    url(r'^users/(?P<user_id>[0-9]+)/unban/$', custom_permission_required(('virtualhost.view_user', 'virtualhost.delete_user'))(views.UnbanUserView.as_view()), name='user-unban'),
    url(r'^users/(?P<user_id>[0-9]+)/expire/$', custom_permission_required(('virtualhost.view_user', 'virtualhost.set_expire_user'))(views.SetUserExpireView.as_view()), name='user-expire'),
