...
urlpatterns = [
    ...
    url(r'^users/(?P<user_id>[0-9]+)/block/$', custom_permission_required(('virtualhost.view_user', 'virtualhost.block_user'))(views.BlockUserView.as_view()), name='user-block'),
    url(r'^users/(?P<user_id>[0-9]+)/unblock/$', custom_permission_required(('virtualhost.view_user', 'virtualhost.unblock_user'))(views.UnblockUserView.as_view()),name='user-unblock'),
