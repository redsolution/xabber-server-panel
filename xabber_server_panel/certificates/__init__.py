...
def challenge_handler(settings):
    ...
    if key in challenge_handlers:
        ...
        try:
            handler_module = importlib.import_module("xabber_server_panel.certificates.modes.{0}".format(mode))
...
default_app_config = 'xabber_server_panel.certificates.apps.CertificatesConfig'