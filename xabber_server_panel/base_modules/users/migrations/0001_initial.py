    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app', models.CharField(choices=[('dashboard', 'Dashboard'), ('users', 'Users'), ('circles', 'Circles'), ('groups', 'Groups'), ('registration', 'Registration'), ('config', 'Settings'), ('dummy_module', 'dummy_module'), ('xabber_web', 'xabber_web')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='User',
