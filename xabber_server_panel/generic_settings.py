...
XMPP_COMPONENT_MAX_ENABLED = False
XMPP_COMPONENT_MAX_PORT = '5237'
XMPP_COMPONENT_MAX_IP = '127.0.0.1'
XMPP_COMPONENT_MAX_HOST = ''
XMPP_COMPONENT_MAX_PASSWORD = ''
...
# MOD_WEBHOOKS_URL = 'http://localhost/webhooks/xmppserver/'
...
MODULES_TEMPLATE = 'config/modules_template.yml'
